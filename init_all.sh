...
PYVER='3.12'
MODEL='https://huggingface.co/sleepdeprived3/Reformed-Christian-Bible-Expert-v2.1-12B_EXL2_4.5bpw_H8'

# Change model if user has modified the variable above
MODEL_NAME=$(basename "$MODEL")
if [ "$MODEL_NAME" != "Reformed-Christian-Bible-Expert-v2.1-12B_EXL2_4.5bpw_H8" ];
then
